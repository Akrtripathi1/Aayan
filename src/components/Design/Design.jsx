    ...
    return (
        ...
        <div className='design'>
            <div className='design-1'>
                <div className='design-1-left'>
                    <video src={design} autoPlay muted loop></video>
                </div>
                <div className='design-1-right'>
                    <h4>Design</h4>
                    <div className='design-1-p'>
                        Digital Marketing
                        Company in India
                    </div>
                        <div className="design-1-button">
                        <button className='design-1-button-1'>
                            Start a project together
                        </button>
                        <button className='design-1-button-2'>
                            Call us
                        </button>
                    </div>
                </div>
            ...
            <div className="design-2">
                <div className="design-2-left">
                    <h4>
                        Design
                    </h4>
                    <p>
                    App development is the creation of a set of programs or technologies that help 
                    perform various tasks required by the business. Therefore, app development is very 
                    important for the portability and usability of the audience’s mobile devices. Mobile 
                    apps send information from different applications to the customers. With mobile apps, 
                    sending messages or spreading information becomes easier.
                    </p>
                </div>
                <div className="design-2-right">
                    <img src={digital2} alt="" />
                </div>
            </div>
            <div className="design-31">
                <div className='design-3-head'>
                    <h4>
                        What we deliver
                    </h4>
                </div>
                <div className='design-3-para'>
                    <p>
